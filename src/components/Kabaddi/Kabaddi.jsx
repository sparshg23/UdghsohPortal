...
//   }
  ...
  const scheduleRef = collection(firestore, 'Kabaddi');
  ...
  const deleteMatch = async (id) => {
    try {
      const matchDoc = doc(db, "Kabaddi", id); // Get document reference by id
  ...
  return (
    ...
    <div className="p-4 md:p-8 lg:p-12">
      <h1 className="text-center text-2xl font-bold mb-6 text-amber-700">Kabaddi Schedule</h1>
