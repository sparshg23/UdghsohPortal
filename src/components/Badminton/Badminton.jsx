...
//   }
  ...
  const scheduleRef = collection(firestore, 'Badminton');
  ...
  const deleteMatch = async (id) => {
    try {
      const matchDoc = doc(db, "Badminton", id); // Get document reference by id
  ...
  return (
    ...
    <div className="p-4 md:p-8 lg:p-12">
      <h1 className="text-center text-2xl font-bold mb-6 text-amber-700">Badminton Schedule</h1>
